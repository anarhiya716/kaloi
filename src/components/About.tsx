    ...
    <>
                ...
                <div className="w-full flex-col justify-center items-start gap-8 flex">
                  <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                    ...
                    <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                      RAZENKO - ваш надежный партнер в поиске талантов. Мы соединяем амбициозные компании 
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">О компании RAZENKO</h2>
          <p className="text-lg text-gray-500">
            RAZENKO - ведущая компания по подбору персонала, которая помогает бизнесу находить и привлекать лучших специалистов на рынке труда. Мы создаем прочные связи между работодателями и талантливыми профессионалами.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-20 lg:max-w-none lg:grid-cols-12">
          <div className="relative lg:order-last lg:col-span-5">
            ...
            <p className="mt-6 text-gray-500">
              Команда RAZENKO состоит из опытных рекрутеров и HR-консультантов с глубоким пониманием различных индустрий. Мы постоянно следим за трендами рынка труда, совершенствуем методологии оценки и развиваем наши компетенции, чтобы предоставлять клиентам сервис высочайшего качества.
            </p>
          </div>

          <div className="max-w-xl text-base leading-7 text-gray-500 lg:col-span-7">
            <p>
              С 2025 года RAZENKO помогает компаниям формировать сильные команды, а специалистам - находить работу своей мечты. Мы разработали уникальную методологию оценки кандидатов, которая позволяет не только оценивать профессиональные навыки, но и определять потенциал для роста и развития.
            </p>
